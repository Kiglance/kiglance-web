  ...
  return register ? (
    <div className={`flex flex-col justify-start items-start ${customClass}`}>
      ...
      <input
        ...
        type={type}
        className={`appearance-none bg-darkGrey relative block w-full px-3 py-2 placeholder-gray-500 focus:appearance-none focus:outline-none focus:ring-1 focus:ring-primary/[0.25] focus:border-primary focus:z-10 sm:text-sm  focus:shadow-sm h-[40px] rounded-md ${inputStyle}`}
